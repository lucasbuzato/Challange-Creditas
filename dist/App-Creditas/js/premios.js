document.addEventListener("DOMContentLoaded", () => {
  const services = [
    { nome: "Seguro Residencial", categoria: ["Seguro", "Imóveis"], imagem: "../imgs/Rectangle 71.png", descricao: "10% de desconto", pontos: "10000" },
    ...
    { nome: "Garantia Locatícia", categoria: ["Imóveis"], imagem: "../imgs/Rectangle 71-1.png", descricao: "3% CashBack", pontos: "15000" },
    { nome: "Financiamento de veículos", categoria: ["Financiamento", "Carro"], imagem: "../imgs/Rectangle 71-1.png", descricao: "5% CashBack", pontos: "15000" },
    { nome: "Empréstimo com Garantia de Veículo", categoria: ["Empréstimo", "Carro"], imagem: "../imgs/Rectangle 71-1.png", descricao: "3% CashBack", pontos: "15000" },
    { nome: "Empréstimo de Imóvel", categoria: ["Empréstimo", "Imóveis"], imagem: "../imgs/Rectangle 71-1.png", descricao: "3% CashBack", pontos: "15000" },
    { nome: "Empréstimo consignado privado", categoria: ["Empréstimo"], imagem: "../imgs/Rectangle 71-1.png", descricao: "3% CashBack", pontos: "15000" },
    { nome: "Financiamento de Imóvel", categoria: ["Financiamento", "Imóveis"], imagem: "../imgs/Rectangle 71-1.png", descricao: "5% CashBack", pontos: "15000" }
  ];
  ...
  if (!premiosList) {
    console.error('Elemento #premiosList não encontrado. Verifique o id no HTML.');
    return;
  }

  let activeCategory = null;

  // 🔎 Filtra por pesquisa e categoria
  ...
  // 🧱 Renderiza os serviços agrupados por pontos
  function renderServices() {
    ...
    pontosOrdenados.forEach(pontos => {
      ...
      // 🟩 Agora TODOS os grupos usam grid de 2 colunas
  ...
  // 🖼️ Re-render após imagens carregarem
